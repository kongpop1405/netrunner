...
echo ============================================
echo   NetRunner - boxrun: speed no-relay no-quit (+17% Speed)
echo   Mystery Box farm - buys +17% Speed, no relay, plays long
...
%PY% main.py --config config/cookierun/_archive/boxrun_speed_noquit.json --launch
set "RC=%ERRORLEVEL%"
